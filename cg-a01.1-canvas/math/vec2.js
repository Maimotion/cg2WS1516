...
define([], 
    ...
    /**
    *project a point p onto a circle defined by p0 and radius
    * return difference between radius and distance between p0 
    * and clicked on point
    */

    vec2.projectPointOnCircle = function(p,p0,radius){
        var dp = vec2.sub(p,p0); 
        var t = vec2.length(dp) - radius;
        return t;
    };
    
    /**
    * project a point p onto a point defined by p0 
    * return distance between p0 and clicked on point
    */
     vec2.projectPointOnPoint = function(p,p0){
        var dp = vec2.sub(p,p0); 
        var t = vec2.length(dp)-1;
        return t;
    };
